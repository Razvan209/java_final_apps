...
public class OrderDataController {
    ...
    public ResponseEntity<ApiResponse> getOrderById(@PathVariable(name = "id")Long id) {
        ...
        optionalOrderData.orElseThrow(() -> new ResourceNotFoundException("Orderul cu id-u" + id +"nu a fost gasit"));

        return ResponseEntity.ok(ApiResponse.success("Orderul a fost gasit cu id-ul"+ id, optionalOrderData.get()));
    }
    ...
    public ResponseEntity<ApiResponse> createOrder(@RequestBody OrderData orderData) {
        ...
        return ResponseEntity.ok(ApiResponse.success("Order salvat cu succes", savedOrder));
    }
    ...
    public ResponseEntity<ApiResponse> updateOrder(@RequestBody OrderData orderData) {
        ...
        return ResponseEntity.ok(ApiResponse.success("Orderul a fost actualizat cu succes", updatedOrder));
    }
    ...
    public ResponseEntity<ApiResponse> deleteOrderById(@PathVariable(name = "id") Long id) {
        ...
        return ResponseEntity.ok(ApiResponse.success("Orderul a fost sters cu succes", null));
    }
